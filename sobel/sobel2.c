...
#include <math.h>
#include <string.h>
//https://github.com/fzehracetin/sobel-edge-detection-in-c
//compiling -> gcc -o sobel2 sobel2.c -lm
//opening the images -> sudo apt-get update && sudo apt-get install imagemagick
